#'  function for MCMC sampling for 3D landmark data (Gaussian likelihood with Isotropic Error Variance)
#'
#' Draws posterior from 9 parameters "c1","c2", "b", "theta_k", "Sigma_k" (k=1,2,3)
#'
...
#'data(apes)
#'myData = apes$x
#'ape_ress_10000=mcmccode_2D(apes$x,10,nrow(myData[,,1]), tune=1,10)
#'}
#'


mcmccode_3D=function(myData, choice, Nlandmark, tune,Nsample)
{
