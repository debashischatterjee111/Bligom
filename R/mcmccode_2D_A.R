#'  function for MCMC sampling for 2D landmark data (Gaussian likelihood with Anisotropic Error Variance)
#'
...
#' "Sigma_k" = Anisotropic error variation parameter (k=0,1,2)
...
mcmccode_2D_A=function(myData, choice, Nlandmark, tune,Nsample)
{
